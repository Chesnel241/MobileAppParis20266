// Contenu par défaut utilisé pour amorcer (seed) la base la première fois.
// L'organisateur le modifie ensuite via le panneau d'administration.
...
// Sections éditables individuellement via PUT /api/admin/content/:section
export const CONTENT_SECTIONS = ["countdownTargetISO", "days", "sessions", "sejour", "paris", "audios", "about"];
