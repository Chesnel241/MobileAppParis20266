...
// Lieux proposés pour l'assignation d'une consultation (espace pasteur)
export const PLACE_LABELS = {
  roomA: { fr: "Salle A - Novotel", en: "Room A - Novotel" },
  roomB: { fr: "Salle B - Novotel", en: "Room B - Novotel" },
  office: { fr: "Bureau privé", en: "Private office" }
};
